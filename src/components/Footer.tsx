...
export default function Footer() {
  ...
  return (
    <footer className="bg-scorpio-dark border-t border-gray-800">
            ...
            <ul className="space-y-3">
              {footerLinks.company.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-gray-400 hover:text-scorpio-primary transition-colors duration-200"
                  >
                    {link.name}
                  </Link>
                </li>
            ...
            <div>
              ...
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded-l-lg text-white placeholder-gray-400 focus:outline-none focus:border-scorpio-primary"
                />
                <button className="px-4 py-2 bg-scorpio-primary text-scorpio-dark font-semibold rounded-r-lg hover:bg-opacity-90 transition-all duration-300">
                  Subscribe
                </button>
              </div>
            </div>
